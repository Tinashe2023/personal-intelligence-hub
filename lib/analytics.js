 ...
 * Supports two modes:
 *   1. GOOGLE_CREDENTIALS_JSON env var containing the full JSON string (for Render / production)
 *   2. GOOGLE_APPLICATION_CREDENTIALS file path (for local development)
 */
function getClient() {
  if (analyticsClient) return analyticsClient;

  // Mode 1 — credentials supplied as a JSON string (production / Render)
  ...
  // Mode 2 — credentials from a local file path (local dev)
